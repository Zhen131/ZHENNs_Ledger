...
export function TradeForm({
  ...
  return (
    ...
    >
      ...
      <TradeFormFeeSourcePanel
        adoptCandidate={adoptCandidate}
        candidateWasModified={candidateWasModified}
        defaultCandidate={defaultCandidate}
        feeRuleMatch={feeRuleMatch}
        form={form}
        selectedCandidate={selectedCandidate}
        selectedFeeRuleId={selectedFeeRuleId}
        setSelectedFeeRuleId={setSelectedFeeRuleId}
        sourceChangedMessage={sourceChangedMessage}
        t={t}
      />
