...
截至 2026-07-16，07A 列出的 6 项 P0/P1 问题已在功能分支
`zhennn/close-week6-week7-07a-risks` 完成实现与自动化复审；尚未合并到源码
`main`，因此不能把这些能力描述为主分支已发布功能。
...
- 当前文件描述的是功能分支事实。
- 源码 `main` 与 `origin/main` 仍停留在 Week 5 Day 6 基线。
- 合并、推送和删除分支必须在复审通过后单独执行。
